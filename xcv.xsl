...
\vspace{1em}&#xA;
  ...
  <!-- OWNER'S ADDRESS -->
<xsl:text>\begin{minipage}[ht]{0.48\textwidth}&#xA;</xsl:text>
...
<xsl:text>\begin{tabular}{L!{\VRule}RRR}&#xA;</xsl:text>
...
<xsl:text>\begin{tabular}{L!{\VRule}RR}&#xA;</xsl:text>
...
<xsl:text>\begin{tabular}{L!{\VRule}RRRRR}</xsl:text>
